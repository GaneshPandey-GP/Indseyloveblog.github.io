...
{
  /* <div
      className="Wrapper container-fluid d-flex align-items-center justify-content-center"
    >
      <div className="registrationFormContainer align-items-center">
        {message && (
          <div
        ...
        <fieldset className="border p-3 rounded">
          ...
          <form
              ...
              className="row"
            >
              <div className="form-group col-sm-6" box>
              ...
              <div className="form-group col-sm-6  boxbox">
              ...
              <div className="form-group col-sm-12 ml-3 box">
              ...
              <button
                ...
                type="submit"
                className="btn btn-outline-success col-sm-12 mt-5"
              >
                Sign Up
              </button>

              <Link
                className="Rlinks mt-3 text-center text-decoration-none"
                to="/login"
                variant="body2"
              >
                {"Already have an account? Sign In"}
