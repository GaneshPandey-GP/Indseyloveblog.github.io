  ...
  return (
      <Accordion square >
        ...
        <ul className="list-group">
            ...
            <li className="list-group-item text-center"><UpdateUser  ifname={fname} ilname={lname} iuid={uid} icontact={contact} iemail={email} itestsGiven={testsGiven} key={uid}/></li>
        </ul>
        </div>
